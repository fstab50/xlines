...
#   Distribution:  Redhat 8, CentOS 8
#   Author: Blake Huber
#
...
REQUIRES='python3,python3-pip,python3-setuptools,python3-pygments,bash-completion,mlocate,which'
...
if lsb_release -sirc | grep -i centos >/dev/null 2>&1; then
    ...
    $_PYTHON3_PATH setup_centos8.py bdist_rpm --requires=${REQUIRES} \
